  ...
  return (
    <article className="Parceldetaillist">
      <div>
        ...
        {results.map((item) => (
          <p key={item.id}>User Name: {item.user_name}</p>
        ))}
        {results.map((item) => (
          <p key={item.id}>User Phoneno: {item.user_phone}</p>
        ))}
        {results.map((item) => (
        ...
        {results.map((item) => (
          <p key={item.id}>Location_name: {item.location_name}</p>
        ))}
        {results.map((item) => (
          <p key={item.id}>Sender: {item.sender}</p>
        ))}
        {results.map((item) => (
          <p key={item.id}>Parcel Notes: {item.notes}</p>
        ))}
      </div>
    </article>
  );
